...
% Last Modified by GUIDE v2.5 13-May-2016 13:31:09
...
function detectMovement(hObject, handles, options, typeIdentifiers)
    ...
    for j=1:nRegions
        ...
        rectangle('Position',mergedBoxes(j,:), 'EdgeColor', color);
    end
...
isVehicle = (box(3) >= vehicleMinWidth && box(3) <= vehicleMaxWidth && ...
            ...
            box(3)/box(4) >= vehicleMinRatio && box(3)/box(4) <= vehicleMaxRatio);
...
isPerson = (box(3) >= personMinWidth && box(3) <= personMaxWidth && ...
            ...
            box(3)/box(4) >= personMinRatio && box(3)/box(4) <= personMaxRatio);
